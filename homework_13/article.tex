...
Thus, we have $\chi'(G') \leq \chi'(G') + 3$, where we know that $ \chi'(G') + 3 = \frac{3k}{2} + 3 = \frac{3k+2}{2}$. With $n = 2$, $n = k$, $n + 2$ all being true, we have shown for $G$ with $\Delta = k$, $\chi'(G') \leq \frac{3k}{2}$
% \section{References}
%
% \nocite{*}
% \raggedright
